        ...
        switch(menu){
            ...
            {if(LoginAdmin()==true){//hay que corregirlo, ponerlo a true
                ...
                do{
                    ...
                    cout << "4 para imprimir clientes" << endl;
                    cout << "5 para ver Vuelos" << endl;
                    cout << "6 para borrar Vuelos" << endl;
                    cout << "r para REGRESAR " << endl;
                    cout << "Marca aqui: ";
                    ...
                    switch(menua){
                        ...
                        case '3': //ImprimirClients(client);
                            break;
                        case '4': //IntroducirVuelo (también te los enseña)
                            break;
                        case '5': //Ver vuelos
                            break;
                        case '6': //Borrar vuelos
                            break;
                        case 'r': cout <<"Has solicitado volver al inicio." << endl;
                            break;
                        default: cout << "No es un caracter valido, vuelve a marcar." << endl;
